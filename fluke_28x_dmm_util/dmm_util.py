...
def usage():
  ...
  print ("")
  print ("  name is the name used for a recording,index is the number")
  print ("  These informations can be displayed with `list` command")
  ...
  print ("  Otherwise it will be taken as a name. Multiple names or indexes are permitted, they must be comma separate")
  print ("")
  print ("set")
  print ("  set company value: set DMM company value")
  print ("  set operator value: set DMM operator value")
  print ("  set site value: set DMM site value")
  print ("  set contact value: set DMM contact value")
  ...
  print ("")
  print ("show")
  print ("  show names : display available names for recordings")
  print ("  show info : display DMM configuration")
  print ("")
  print ("list")
  print ("  list recordings : list recording type recordings")
  print ("  list minmax : list minmax type recordings")
  print ("  list peak : list peak type recordings")
  print ("  list all : list all recordin")
  print ("")
  print ("display")
  print ("  Use this to display DMM realtime value")
  print ("")
  sys.exit()
